    ...
    const getData = async () => {
      try {
        const response = await axios.get(
          ...
          config.backendURL + `/activities/user/me?type=${typeQuery}&sort=${orderType}&take=${take}`,
          // `https://loglifegov1-1071770156665.asia-southeast3.run.app/activities?type=${typeQuery}&sort=${orderType}&take=${take}`,
  ...
  const fetchMoreData = () => {
    axios
      .get(
        ...
        config.backendURL + `/activities/user/me?type=${typeQuery}&sort=${orderType}&skip=${skip}&take=5`,
        // `https://loglifegov1-1071770156665.asia-southeast3.run.app/activities?type=${typeQuery}&sort=${orderType}&skip=${skip}&take=5`,
        {
          // withCredentials: true,
          withCredentials: true,
        },
